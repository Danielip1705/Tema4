...
public class Ej19 {
	...
	/***
	 * Funcion que convierte una cadena con minusculas y mayusculas a nomenclatura camel (estoEsCamel)
	 * @param frase Cadena escrita por el usuario que contiene mayusculas y minusculas
	 * @return Cadena sin espacio y con la nomenclatura camel
	 */
	public static String pasarCamel(String frase) {
		
		//Cremaos Array de string e inicializamos a frase sin los espacios utilizando .split
		String[]pasar= frase.split(" ");
